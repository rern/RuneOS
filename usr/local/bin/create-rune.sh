...
# rank mirrorlist
curl -O https://graw.githubusercontent.com/rern/RuneOS/raw/master/srv/http/addons-functions.sh
curl -O https://raw.githubusercontent.comrern/RuneAudio/raw/master/rankmirrors/rankmirrors.sh
