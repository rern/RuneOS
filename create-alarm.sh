...
9 "$upmpdcli" on )
	...
	[[ $select == *' 2 '* ]] && features+='chromium matchbox-window-manager upower xf86-video-fbdev xf86-video-fbturbo xf86-video-vesa xinput_calibrator xorg-server xorg-xinit ' && list+="$chromium"$'\n'
